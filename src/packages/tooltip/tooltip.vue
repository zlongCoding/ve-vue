...
.content-wrapper {
  ...
  &.ve-position-top {
    ...
    &.ve-position-border {
      ...
      &::after {
        border-top-color: $border-bg;
      }
    }
    &.ve-position-no-border {
      &::before {
        border-top-color: $no-border-style;
      }
      &::after {
        border-top-color: $no-border-bg;
      }
    }
  }
  &.ve-position-bottom {
    ...
    &.ve-position-border {
      ...
      &::after {
        border-bottom-color: $border-bg;
      }
    }
    &.ve-position-no-border {
      &::before {
        border-bottom-color: $no-border-style;
      }
      &::after {
        border-bottom-color: $no-border-bg;
      }
    }
  }
  &.ve-position-left {
    ...
    &.ve-position-border {
      ...
      &::after {
        border-left-color: $border-bg;
      }
    }
    &.ve-position-no-border {
      &::before {
        border-left-color: $no-border-style;
      }
      &::after {
        border-left-color: $no-border-bg;
      }
    }
  }
  &.ve-position-right {
    ...
    &.ve-position-border {
      ...
      &::after {
        border-right-color: $border-bg;
      }
    }
    &.ve-position-no-border {
      &::before {
        border-right-color: $no-border-style;
      }
      &::after {
        border-right-color: $no-border-bg;
      }
    }
  }
  &.ve-position-border {
  ...
  &.ve-position-no-border {
    border: 1px solid $no-border-style;
    color: $no-border-color;
    background: $no-border-bg;
  }
}
</style>
